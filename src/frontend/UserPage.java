...
public class UserPage extends javax.swing.JFrame {
    ...
    void setCurrentFriendsPanel () {
        ...
        for (String userID : this.loggedInUser.getProfile().getFriends()) {
            fp = new FriendsPanel (this.loggedInUser, userDB.searchUserByUserId(userID), this.FM, "Current", getWidth()-20, getHeight()-30);
            fp.setSize( this.friendsContentPanel.getWidth(), 200);
            fp.setVisible(true);
            this.friendsPages.addToCurrentFriendsPanel(fp);
        }
    ...
    void setFriendRequestsPanel () {
        ...
        for (String userID : this.loggedInUser.getProfile().getPending()) {
            fp = new FriendsPanel (this.loggedInUser, userDB.searchUserByUserId(userID), this.FM, "Request", getWidth()-20, getHeight()-30);
            fp.setSize( this.friendsContentPanel.getWidth(), 200);
            fp.setVisible(true);
            this.friendsPages.addToFriendRequestsPanel(fp);
        }
        ...
        for (String friendID : loggedInUser.getProfile().getFriends()) {
            for (String suggestedFriendID : UserDB.getInstance().searchUserByUserId(friendID).getProfile().getFriends()) {
                if (!loggedInUser.getProfile().getFriends().contains(suggestedFriendID) // not already friends
                    ...
                    fp = new FriendsPanel (this.loggedInUser, userDB.searchUserByUserId(suggestedFriendID), this.FM, "Searched", getWidth()-20, getHeight()-30);
                    fp.setSize( this.friendsContentPanel.getWidth(), 200);
                    fp.setVisible(true);
                    this.friendsPages.addToSuggestedFriendsPanel(fp);
                }
            }
        }
