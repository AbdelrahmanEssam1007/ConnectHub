...
public class Notifications extends javax.swing.JPanel {
    ...
    private void loadNoti() {
        panel.add(new Item());
        panel.add(new Item(new ImageIcon("frontend/p1.jpg"), "Steve", "answered to your comment", "a day ago"));
        panel.add(new Item(new ImageIcon("frontend/p1.jpg"), "Sophie", "answered to your comment", "1 day ago"));
        panel.add(new Item(new ImageIcon("frontend/p1.jpg"), "Dara", "answered to your comment", "2 day ago"));
        panel.add(new Item(new ImageIcon("frontend/p1.jpg"), "Steve", "answered to your comment", "a day ago"));
        panel.add(new Item(new ImageIcon("frontend/p1.jpg"), "Sophie", "answered to your comment", "1 day ago"));
        panel.add(new Item(new ImageIcon("frontend/p1.jpg"), "Dara", "answered to your comment", "2 day ago"));
        panel.add(new Item(new ImageIcon("frontend/p1.jpg"), "Steve", "answered to your comment", "a day ago"));
